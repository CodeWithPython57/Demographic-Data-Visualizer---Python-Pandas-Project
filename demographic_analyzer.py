...
def calculate_demographic_data(print_data=True):
    # Read data from file
    global df 
    df = pd.read_csv('https://raw.githubusercontent.com/a-mt/fcc-demographic-data-analyzer/master/adult.data.csv')
    # How many  each race are represented in this dataset? 
